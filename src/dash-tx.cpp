...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("AppleCoin Core AppleCoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  AppleCoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded AppleCoin transaction") + "\n" +
              "  AppleCoin-tx [options] -create [commands]   " + _("Create hex-encoded AppleCoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded AppleCoin transaction
