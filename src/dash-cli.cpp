...
static int AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("AppleCoin Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  AppleCoin-cli [options] <command> [params]  " + _("Send command to AppleCoin Core") + "\n" +
                  "  AppleCoin-cli [options] help                " + _("List commands") + "\n" +
                  "  AppleCoin-cli [options] help <command>      " + _("Get help for a command") + "\n";
