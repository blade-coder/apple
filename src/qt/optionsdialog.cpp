    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("APPLE-light"), QVariant("light"));
    ui->theme->addItem(QString("APPLE-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("APPLE-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("APPLE-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("APPLE-traditional"), QVariant("trad"));
