    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("AppleCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About AppleCoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  AppleCoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the AppleCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 APPLE, 0.1 APPLE, 1 APPLE and 10 APPLE -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("AppleCoin Core is shutting down...") + "<br /><br />" +
