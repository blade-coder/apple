    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("AppleCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a AppleCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and AppleCoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About AppleCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about AppleCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for AppleCoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your AppleCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified AppleCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a AppleCoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the AppleCoin Core help message to get a list with possible AppleCoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("AppleCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to AppleCoin network", "", count));
    } else {
...
{
    QString strTitle = tr("AppleCoin Core"); // default title
    ...
    // Append title to "AppleCoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
