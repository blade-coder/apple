...
//                sph_radiogatun64 (&ctx_radiogatun, toHash, lenToHash);
//                sph_radiogatun64_close(&ctx_radiogatun, static_cast<void*>(&hash[i]));
//                break;
//           case 19:
//                sph_panama_init(&ctx_panama);
//                sph_panama (&ctx_panama, toHash, lenToHash);
//                sph_panama_close(&ctx_panama, static_cast<void*>(&hash[i]));
//                break;L
//        }
//    }

//    return hash[19].trim256();
