...
#define BOOST_TEST_MODULE AppleCoin Test Suite

#include "test_AppleCoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_AppleCoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
