...
2. run AppleCoind with -printalert or -sendalert like this:
   /path/to/AppleCoind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.AppleCoin.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/AppleCoin Core:0.12.0.58/"));
