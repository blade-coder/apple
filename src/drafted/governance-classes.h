 ...
 *
 *   // network
 *   CAppleCoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.AppleCoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CAppleCoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CAppleCoinNetwork(UniValue objIn)
    {
...
// // can be under: AppleCoinNetwork
// //   -- signature requirements : Key1(User)
// class CAppleCoinNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == AppleCoinNetwork);
//     // }
