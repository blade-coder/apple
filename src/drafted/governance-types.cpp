...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "AppleCoinNetwork") type = AppleCoinNetwork;
    if(strType == "AppleCoinNetworkVariable") type = AppleCoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == AppleCoinNetwork) s = "AppleCoinNetwork";
    if(type == AppleCoinNetworkVariable) s = "AppleCoinNetworkVariable";
